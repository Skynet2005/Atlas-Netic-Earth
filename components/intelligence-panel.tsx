"use client";
import { Activity, Flame, Satellite, CloudLightning, RefreshCw, Clock3 } from 'lucide-react';
...
export function IntelligencePanel({ layers, onChange, feeds, satelliteGroup, onSatelliteGroup, replayMinutes, onReplay, diagnostics }: {
