...
const social = readFileSync(new URL('../app/opengraph-image.tsx', import.meta.url), 'utf8');
...
test('social preview uses a real NASA Earth image instead of a synthetic globe', () => {
  assert.match(social, /assets\.science\.nasa\.gov/);
  assert.match(social, /PIA18033\.jpg/);
  assert.match(social, /NASA \/ SUOMI NPP/);
});
